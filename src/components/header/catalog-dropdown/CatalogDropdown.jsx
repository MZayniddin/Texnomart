...
const CatalogDropdown = ({ isCatalogActive }) => {
  ...
  return (
    <div
      className={
        isCatalogActive
          ? "catalog-dropdown catalog-dropdown__active"
          : "catalog-dropdown"
      }
    >
            ...
            <div className="catalog-nav">
              <ul>
                {catalogData.map(({ id, category, imgURL }) => (
                  <li
                    key={id}
                    className={id === activeList ? "catalog__active" : null}
                    onMouseOver={() => {
                      setActiveList(id);
                    }}
                  >
          ...
          <div className="catalog-right">
            {catalogData.map(({ id, category, data }) => (
              <aside
                key={id}
                style={
                  activeList === id ? { display: "block" } : { display: "none" }
                }
              >
