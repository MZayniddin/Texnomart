...
const HeaderNavMobile = ({
  ...
  return (
    <div
      className={
        isHeaderNavMobileActive
          ? "header-nav-mobile header-nav-mobile__active"
          : "header-nav-mobile"
      }
    >
        ...
        <div className="nav-top-login">
          ...
          <div style={{ display: "flex", alignItems: "center" }}>
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <button className="nav-top-btn-register">
                Ro'yxatdan o'tish
              </button>
            </div>
          </div>
      ...
      <div className="header-nav-list">
        <ul>
          <li>
            <button
              className="nav-link nav-link__catalog"
              onClick={() => {
                setMobSidebarActive(true);
                setIsHeaderNavMobileActive(false);
              }}
            >
              ...
              <span className="nav-link__text">Maxsulotlar katalogi</span>
            </button>
          </li>
          <li>
            <Link className="nav-link" to="/">
              ...
              <span className="nav-link__text">Bizning do'konlarimiz</span>
            </Link>
          </li>
          <li>
            <Link className="nav-link" to="/">
              ...
              <span className="nav-link__text">B2B savdosi</span>
            </Link>
          </li>
          <li>
            <Link className="nav-link" to="/">
          ...
          <li>
            <Link className="nav-link" to="/">
              ...
              <span className="nav-link__text">Buyurmat holati</span>
            </Link>
          </li>
          <li
            onClick={() => {
          ...
          >
            <span className="nav-link nav-link__accordion">
              <div style={{ display: "flex", alignItems: "center" }}>
                ...
                <span className="nav-link__text">Ma'lumot</span>
              </div>
              <span
          ...
          <li>
            ...
            <div className="nav-link nav-link__accordion">
              <div style={{ display: "flex", alignItems: "center" }}>
                ...
                <span className="nav-link__text">Til</span>
              </div>
              <div style={{ display: "flex", alignItems: "center" }}>
                <Link className="nav-language-link" to="/">
                  Ру
                </Link>
                <Link
                  className="nav-language-link nav-language-link__active"
                  to="/"
                >
                  O'z
                </Link>
